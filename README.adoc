...
image:https://github.com/baldir-fr/baldir-vcf-tools/actions/workflows/generate-docs-and-publish-with-github-pages.yml/badge.svg?event=page_build[Generate and deploy static content to Pages,link="https://github.com/baldir-fr/baldir-vcf-tools/actions/workflows/generate-docs-and-publish-with-github-pages.yml",window="_blank"]
